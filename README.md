...
For the purposes of this Privacy Policy:
    ...
    Application means the software program provided by the Company downloaded by You on any electronic device, named Nat Geo: Egypt Documentaries.

    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nat Geo: Egypt Documentaries.
